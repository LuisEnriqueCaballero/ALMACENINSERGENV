...
$sql7 = "SELECT TSAL.FECHA_SALIDA, if(SUM(TSAL.CANTIDAD*TSAL.PRECIO_UNITARIO) IS NULL,0.00,SUM(TSAL.CANTIDAD*TSAL.PRECIO_UNITARIO)) FROM salida_material AS TSAL
LEFT JOIN producto AS TPRO ON TSAL.ID_PRODUCTO=TPRO.ID_MONEDA
WHERE TPRO.ID_MONEDA=2
GROUP BY TSAL.FECHA_SALIDA
ORDER BY TSAL.FECHA_SALIDA";

$query = mysqli_query($cnx, $sql7);
...
?>
    ...
    <div class="col-sm-12" id="graficalineal">
...
<script type="text/javascript">
    ...
    var data = [trace1];
    var layout = {
  title: 'Grafico de consumo Dolares',
  xaxis: {
    title: 'Fecha de dia',
    showgrid: false,
    zeroline: false
