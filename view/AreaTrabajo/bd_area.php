...
<div class="inf_inserngev">
    ...
    <div class="panel_proceso">
        <div class="boton">
            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#nuevoarea">
            ...
            <table class="table table-sm table-bordered" id="example">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">&aacute;rea</th>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <button type="button" class="btn btn-outline-success"
                                                                data-toggle="modal" data-target="#updatearea"
