...
WHERE TVEH.ESTADO='TRANSFORMACION'
            ...
            <table class="table table-sm table-bordered" id="example">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">MOTOR</th></th>
                        <th scope="col" class="text-center">VIN <br> SERIE</th>
                        <th scope="col" class="text-center">TIPO COMBUSTIBLE</th>
                        <th scope="col" class="text-center">FABIRCACION <br>A&Nacute;IO</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
