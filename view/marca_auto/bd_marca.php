...
<div class="inf_inserngev">
    <h1>marca de autos</h1>
    <div class="panel_proceso">
        <div class="boton">
            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#nuevomarca">
            ...
            <table class="table table-sm table-bordered" id="example">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">marca vehiculos</th>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <button type="button" class="btn btn-outline-success"
                                                                data-toggle="modal" data-target="#updatemarca"
