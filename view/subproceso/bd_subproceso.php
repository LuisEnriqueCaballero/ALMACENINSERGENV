...
$sql="SELECT * FROM VWPROCEDIMIENTO";
$query=mysqli_query($cnx,$sql);
?>

<div class="inf_inserngev">
    <h1>lista procedimiento</h1>
    <div class="panel_proceso">
        <div class="boton">
            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#nuevoprocedimiento">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <button type="button" class="btn btn-outline-success"
                                                                data-toggle="modal" data-target="#updateprocedimiento" onclick="obtenerdatos(<?php echo $ver[0]?>)">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            ...
                                                            onclick="EliminarDato(<?php echo $ver[0]?>)">
